...
const Navbar = () => {
    ...
    return (
        <div className="flex justify-between p-2 md:mx-6 relative">
           <input className="inpbox" type="text" placeholder="Client Search.."/>
             <select name="drop" id="drop" className='selectbox'>
          ...
          <div className='flex'>
           ...
           <TooltipComponent content='Profile' position='BottomCenter'>
            ...
            >
              ...
              />
                <p>
                  <span className='textnav'>Hi</span>{' '}<span className='textnav2'>Alpha</span>
                </p>
